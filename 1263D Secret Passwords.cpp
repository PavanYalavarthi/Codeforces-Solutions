/*
Problem credits: https://codeforces.com/problemset/problem/1263/d
...
Input
The first line contain integer n (1<=n<=2.10^5) - number of passwords in the list. 
Next n lines contains passwords from the list - non-empty strings si, with length at most 50 letters. Some of the passwords may be equal.
...
/*
Solution:
    Convert string to push index to charecter vector and construct graph from it.

    And find no.of components
*/
#include<bits/stdc++.h>
using namespace std;
vector<bool>visited;
